...
// ADDED FACE FRAME READERS
Kinect2.prototype.openFaceReader = function() {
	return this.nativeKinect2.openFaceReader(this.faceFrameCallback);
};
...
// ADDED FACE FRAME CALLBACK
Kinect2.prototype.faceFrameCallback = function(data) {
	self.emit('faceFrame', data);
};
